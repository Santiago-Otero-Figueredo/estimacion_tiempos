...
class RegistrarProyectoEmpleado(LoginRequiredMixin, MensajeMixin, CreateView):
...
class ModificarProyectoEmpleado(LoginRequiredMixin, MensajeMixin, UpdateView):
    model = ProyectoEmpleado
    form_class = RegistrarProyectoEmpleadoForm
...
class ListadoProyectosEmpleados(LoginRequiredMixin, ListView):
    model = ProyectoEmpleado
